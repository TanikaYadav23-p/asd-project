...
export default function RejectKYCModal({
  ...
  const isValid = selectedReasons.length > 0 && note.trim().length > 0;
  ...
  return (
    <div className="fixed inset-0 bg-slate-500/40 flex items-start sm:items-center justify-center p-2 sm:p-6 z-50">
      <form
      ...
      >
        <div className="flex items-start justify-between gap-3 p-4 sm:p-6 border-b border-gray-100 shrink-0">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h2 className="text-base sm:text-lg font-bold text-gray-900">Reject KYC Verification</h2>
          </div>
        ...
        <div className="p-4 sm:p-6 space-y-5 overflow-y-auto">
          <div className="flex items-start gap-3 bg-red-50 border border-red-100 rounded-xl p-4">
            ...
            <p className="text-xs text-gray-700">
              <span className="font-semibold text-gray-900">KYC will be marked as Rejected.</span>{" "}
              The user will be notified via email/SMS to resubmit valid documentation.
            </p>
          </div>
          ...
          <div>
            <label className="text-xs font-semibold text-gray-800">
              Mandatory Rejection Note <span className="text-red-500">*</span>
            </label>
            <textarea
              value={note}
              maxLength={500}
