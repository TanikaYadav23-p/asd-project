          ...
          <div className="min-w-[700px]">
            ...
            {filtered.map((r) => (
              ...
              >
                ...
                <span className="text-xs text-gray-500">{r.route}</span>
                <span className="text-xs text-gray-500">{r.submittedOn}</span>
                <span className="text-xs text-gray-500">{r.shipmentType}</span>
                <span className="text-xs text-yellow-600 bg-yellow-50 px-2 py-1 rounded-full w-fit">
                  {r.status}
                </span>
