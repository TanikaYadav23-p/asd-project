...
export default function UploadShipment({ onClose }) {
    ...
    <div className="fixed inset-0 bg-black/50 flex items-start sm:items-center justify-center p-2 sm:p-4 z-50">
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-xl my-4 sm:my-0 flex flex-col max-h-[80vh]">
        <div className="flex items-start gap-3 p-4 sm:p-6 shrink-0">
          ...
          <div>
            <h2 className="text-base sm:text-lg font-bold text-gray-900">Upload Shipment</h2>
            <p className="text-xs sm:text-sm text-gray-400 mt-0.5">Upload shipment file and details</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-4 sm:px-6 pb-4 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-800 mb-1.5">Shipment Type</label>
            <input
              type="text"
              name="contractName"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-800 mb-1.5">Upload Document</label>
            <div
