...
export default function B2CUsers() {
  ...
  const deleteUser = async (id) => {
    ...
    try {
      await fetch("/api/b2c-users/" + id, { method: "DELETE" });
    } catch (err) {}
  };
    ...
    <div className="w-full max-w-6xl mx-auto bg-white rounded-2xl shadow-xl p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">B2C Users</h2>
